...
<body style="overflow: hidden;">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-7">
                      ...
                      <p class="text-sm mb-0">
                        ...
                        <span class="font-weight-bold ms-1">Rekap pengembalian hari ini</span>
                      </p>
                    </div>
                ...
                <div class="card-body px-0 pb-2">
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                      <thead>
                        <tr>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Id Pengembalian</th>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Keterlambatan</th>
                      ...
                      <tbody id="pengembalianTableBody">
                        <tr>
                          ...
                          <td>
                            <p class="text-xs text-secondary mb-0">Fiction</p>
                          </td>
                          <td>
                            <p class="text-xs text-secondary mb-0">John Michael</p>
                          </td>
                          <td>
                            <p class="text-xs text-secondary mb-0">Jane Doe</p>
                          </td>
                          <td >
                            <span class="text-secondary text-xs font-weight-bold">23/05/24</span>
                          </td>
                          <td >
                            <span class="text-secondary text-xs font-weight-bold">0 days</span>
                          </td>
                          <td >
                        ...
                        <tr>
                          ...
                          <td>
                            <p class="text-xs font-weight-bold mb-0">12346</p>
                          </td>
                          <td>
                          ...
                          <td>
                            <p class="text-xs text-secondary mb-0">John Smith</p>
                          </td>
                          <td >
                            <span class="text-secondary text-xs font-weight-bold">24/05/24</span>
                          </td>
                          <td >
                            <span class="text-secondary text-xs font-weight-bold">2 days</span>
                          </td>
                          <td >
                            <span class="text-secondary text-xs font-weight-bold">$2.00</span>
                          </td>
                        </tr>
  ...
  <!-- Add this script for CSV download functionality -->
  <script>
    function downloadCSV() {
      ...
      rows.forEach(row => {
        ...
        var rowData = cols.map(col => col.innerText).join(",");
        csvContent += rowData + "\n";
      });
      ...
      a.setAttribute("download", "pengembalian.csv");
    ...
    table = document.getElementById("pengembalianTableBody");
