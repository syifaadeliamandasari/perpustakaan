    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('loginForm').addEventListener('submit', function(event) {
            ...
            if (email === '') {
                ...
                // Optional: Additional validation logic for email format
        ...
        @if(session('insecurePassword'))
            alert('Your password is insecure. Please change your password.');
        @endif

        if ($loginSuccessful) {
    if ($passwordIsInsecure) {
        session(['insecurePassword' => true]);
    }
