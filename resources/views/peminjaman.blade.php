        ...
        <table id="tableData">
          <thead>
            <tr>
              ...
              <th>Status</th>
              <th>Pilihan</th> <!-- Kolom untuk tombol edit dan hapus -->
            </tr>
          </thead>
          <tbody id="tbodyData">
            <!-- Isi dari tabel akan ditampilkan di sini -->
          </tbody>
        </table>
      </div>
      <!-- Modal Tambah/Edit Data Peminjaman -->
<div id="modalPeminjaman" style="display: none;">
    <div class="container">
      <h2 id="modalTitle">Tambah Data Peminjaman</h2>
      <form id="formPeminjaman">
        <label for="buku">Buku:</label><br>
        <input type="text" id="inputBuku" placeholder="Nama Buku">
          <!-- Pilihan buku akan ditampilkan di sini -->
        </select><br><br>

        <label for="nama">Nama:</label><br>
        <input type="text" id="nama" placeholder="nama" required><br><br>

        <label for="tglPeminjaman">Tanggal Peminjaman:</label><br>
        <input type="date" id="tglPeminjaman" name="tglPeminjaman" required><br><br>

        <label for="tglJatuhTempo">Tanggal Jatuh Tempo:</label><br>
        <input type="date" id="tglJatuhTempo" name="tglJatuhTempo" required><br><br>
        ...
        <button type="button" class="btn btn-danger" id="btnBatalPeminjaman">Batal</button>
      </form>
    </div>
  </div>
<script>
